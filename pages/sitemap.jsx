...
const Sitemap = () => {
    ...
    const sitemapSections = [
        ...
        },
        {
            ...
            items: [
                { label: t('sitemap:sections.cancer.items.oncologicalSurgeries'), path: processSitemapPath('/cancer') },
                { label: t('sitemap:sections.cancer.items.endometrialCancer'), path: processSitemapPath('/cancer/endometrial-cancer') },
                { label: t('sitemap:sections.cancer.items.cervicalCancer'), path: processSitemapPath('/cancer/cervical-cancer') },
                { label: t('sitemap:sections.cancer.items.uterineSarcoma'), path: processSitemapPath('/cancer/uterine-sarcoma') },
                { label: t('sitemap:sections.cancer.items.fallopianTubeCancer'), path: processSitemapPath('/cancer/fallopian-tube-cancer') },
                { label: t('sitemap:sections.cancer.items.vaginalCancer'), path: processSitemapPath('/cancer/vaginal-cancer') },
                { label: t('sitemap:sections.cancer.items.vulvarCancer'), path: processSitemapPath('/cancer/vulvar-cancer') },
                { label: t('sitemap:sections.cancer.items.choriocarcinoma'), path: processSitemapPath('/cancer/choriocarcinoma') },
                { label: t('sitemap:sections.cancer.items.metastaticTumors'), path: processSitemapPath('/cancer/metastatic-tumors') },
                { label: t('sitemap:sections.cancer.items.molarPregnancy'), path: processSitemapPath('/cancer/molar-pregnancy') },
            ]
        },
        {
